...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { date1, date2, type, relationshipType, hour1, hour2, prompt, name1, name2, gender1, gender2, isFollowUp, sessionId, request_id } = body;
    ...
    if (prompt) {
      ...
      try {
        ...
        return handleBillingStream(req, 'synastry', {
          prompt,
